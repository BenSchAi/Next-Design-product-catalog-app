...
def process_excels():
    ...
    # הוספנו supportsAllDrives=True ו-includeItemsFromAllDrives=True כדי שימצא את התיקיות בכונן המשותף
    ...
    if not excels:
        print("⚠️ לא נמצאו קבצי אקסל. וודא שהעלית אותם לתיקייה הנכונה בכונן המשותף.")
        return
                ...
                for pic_idx in range(sheet.Pictures.Count):
                    ...
                    with tempfile.NamedTemporaryFile(delete=False, suffix=".png") as tmp_img:
                        ...
                        service.files().create(
                            ...
                            media_body=media,
                            supportsAllDrives=True # קריטי להעלאה לכונן משותף
                        ).execute()
